    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: "Public key",
          configured: isConfigured(process.env.PAYSTACK_PUBLIC_KEY),
        },
        {
          key: "paystackCallbackUrl",
          label: "Callback URL",
          configured: isConfigured(process.env.PAYSTACK_CALLBACK_URL),
          value: getSafeUrl(process.env.PAYSTACK_CALLBACK_URL),
        },
        {
          key: "paystackCurrency",
          label: "Currency",
          configured: isConfigured(process.env.PAYSTACK_CURRENCY),
